...
#                                       - _generate_nx_graph: generates NetworkX graph            #
#                                              from the Voronoi points                            #
#                                                                                                 #
#                                       - _networkx_graph_shortest_path: calculates the           #
#                                              shortest path through the Voronoi                  #
#                                              points to generate centerline                      #
#                                                                                                 #
#                                       - _centerline_path: determines all possible               #
#                                              paths generated by the Voronoi points              #
#                                                                                                 #
#                                       - _equal_distance_centerline: interpolate the             #
#                                              centerline at an equal physical distance           #
#                                                                                                 #
#                                       - _evenly_spaced_centerline: interpolate the              #
#                                              centerline at an evenly spaced distance            #
#                                                                                                 #
#                                       - _smoothed_centerline: b-spline smooth the               #
#                                              centerline                                         #
#                                                                                                 #
#                                                                                                 #
#                                                                                                 #
