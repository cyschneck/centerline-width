...
def saveCenterlineMAT(river_object=None, save_to_mat=None, centerline_type="Voronoi"):
	...
	centerline_dict = {latitude_header: latitude_lst, longitude_header: longtiude_lst}
